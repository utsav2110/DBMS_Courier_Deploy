...
# -----------------------------------------------
# ➕ TAB 3: Insert Data (placeholder for now)
# -----------------------------------------------
with tab3:
...
# -----------------------------------------------
# 📊 TAB 4: Graphs (placeholder for now)
# -----------------------------------------------
with tab4:
    st.header("📊 Graphs & Analytics")
    
    # Query 4: Top 5 Most Rated Drivers
    ...
    # Query 12: Branches with Revenue > 5000
    ...
    # Query 15: Courier Count by Type and Status
    ...
    # Query 16: Most Frequently Used Payment Methods
    ...
    # Query 18: Most Profitable Courier Types
    ...
    # Query 19: Average Delivery Time by Type
